	...
	int diffCount = 0;
        ...
        for (m = 0, n = m + 1; m < fileLength-1;) {
                ...
                if (mem[m] != mem[n]) {
                        ...
                        //n++;
			int diffNum[] = {1};
                        //fwrite(diffNum, sizeof(int), 4, stdout);
			fwrite(diffNum, sizeof(int), 4, writep);
			//putc(mem[m], stdout);
			putc(mem[m], writep);
                        m++;
                        n++;
                ...
                if (letterCount > 1) {
                        ...
                        //fwrite(&test, sizeof(int), 4, stdout);
			fwrite(&test, sizeof(int), 4, writep);
                        //putc(mem[temp], stdout);
